...
import com.shivam.musicplayer.Adapters.AlbumDetailAdapter;
...
public class AlbumDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewDetails = findViewById(R.id.recyclerViewDetail);
    ...
    protected void onResume() {
        ...
        if (!(albumSongs.size() < 1))
        {
             ...
             recyclerViewDetails.setAdapter(albumDetailAdapter);
             recyclerViewDetails.setLayoutManager(new LinearLayoutManager(this, RecyclerView.VERTICAL, false));
